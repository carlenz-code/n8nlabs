  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* WhatsApp */}
        <a href="https://wa.me/34638619588" target="_blank" rel="noopener noreferrer" style={{ display:"flex", alignItems:"center", gap:"0.4rem", fontSize:"0.75rem", color:"#1a1a1a", textDecoration:"none", fontFamily:"var(--font-poppins)", letterSpacing:"-0.01em", fontWeight:600 }}>
        ...
        <a href="https://maps.google.com/?q=Calle+Joaquín+María+López+26+Madrid" target="_blank" rel="noopener noreferrer" className="hidden sm:flex" style={{ alignItems:"center", gap:"0.4rem", fontSize:"0.75rem", color:"#666", textDecoration:"none", fontFamily:"var(--font-poppins)", letterSpacing:"-0.01em" }}>
